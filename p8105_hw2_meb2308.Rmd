...
I will read and clean the NYC transit dataset, keeping important variables. I then converted the entry variable from a character to a logical variable.
...
```
There are `r count(distinct(subway_tidy_data, station_name))` distinct stations, and 73 are ADA compliant. Among the 447 stations without vending machines, 139 (0.31%) allow entry.
