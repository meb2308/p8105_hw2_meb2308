...
```
There are 356 distinct stations, and 73 are ADA compliant. Among the 447 stations without vending machines, 139 (0.31%) allow entry.

I already made the route number and name distinct variables during my data tidying process. I determine how many stations serve the A train, and among those, how many are ADA compliant below. 
...
filter (subway_tidy_data, route == "A") %>% 
  filter(ada == TRUE)
```
There are 273 distinct stations that serve the A train. Of these, 107 are ADA compliant.
