...
variables. I then converted the entry variable from a character to a
logical variable.
...
```
    ...
    ## # A tibble: 0 x 9
    ## # … with 9 variables: line <chr>, station_name <chr>, station_location <chr>,
    ## #   vending <chr>, entry <lgl>, entrance_type <chr>, ada <lgl>,
    ## #   route_order <chr>, route <chr>
...
```
    ...
    ##   line  station_name station_location vending entry entrance_type ada  
    ##   <chr> <chr>        <chr>            <chr>   <lgl> <chr>         <lgl>
    ## 1 4 Av… 53rd St      (40.645069, -74… NO      FALSE Stair         FALSE
    ## 2 4 Av… 77th St      (40.629742, -74… NO      FALSE Stair         FALSE
    ## 3 4 Av… 9th St       (40.670847, -73… NO      TRUE  Stair         FALSE
...
There are 356 distinct stations, and 381 73 are ADA compliant. Among the
447 stations without vending machines, 139 (0.31%) allow entry.
...
```
    ...
    ##   line  station_name station_location vending entry entrance_type ada  
    ##   <chr> <chr>        <chr>            <chr>   <lgl> <chr>         <lgl>
    ## 1 42nd… Times Square (40.755983, -73… YES     TRUE  Stair         FALSE
    ## 2 8 Av… 125th St     (40.811109, -73… YES     TRUE  Stair         FALSE
    ## 3 8 Av… 125th St     (40.811109, -73… YES     TRUE  Stair         FALSE
...
```
    ...
    ##   line  station_name station_location vending entry entrance_type ada  
    ##   <chr> <chr>        <chr>            <chr>   <lgl> <chr>         <lgl>
    ## 1 8 Av… 14th St      (40.740893, -74… YES     TRUE  Easement      TRUE 
    ## 2 8 Av… 14th St      (40.740893, -74… YES     TRUE  Stair         TRUE 
    ## 3 8 Av… 14th St      (40.740893, -74… YES     TRUE  Stair         TRUE 
